...
Ext.define('Sch.lib.DetailsPanel', {
     ...
     */
    appJSPath: '/gantt/baseline/app.js',
     ...
     */
    skipFiles: ['/gantt/examples-shared.js', '/gantt/lib/prism.js'],
    ...
    if (!window.Prism && !Ext.isIE) {
        Ext.Loader.loadScript('/gantt/lib/prism.js');
    }
});